...
public class NCCTab extends PreferencePanel
{
	...
	public void init()
	{
		...
		enableResistorChecking.setSelected(NccPreferences.getCheckResistors());
	...
	public void term()
	{
		...
		currBoolean = enableResistorChecking.isSelected();
    ...
    private void initComponents()
    {
        ...
        enableResistorChecking = new javax.swing.JCheckBox();
        ...
        operation.setBorder(javax.swing.BorderFactory.createTitledBorder("Operations"));
        ...
        enableResistorChecking.setText("Check Resistors");
        enableResistorChecking.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        sizeChecking.add(enableResistorChecking, gridBagConstraints);
    ...
    private javax.swing.JCheckBox enableResistorChecking;
