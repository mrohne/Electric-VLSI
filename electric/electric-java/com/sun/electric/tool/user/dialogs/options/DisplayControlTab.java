...
public class DisplayControlTab extends PreferencePanel
{
	...
	public void init()
	{
		...
		overallScreenScale.setText(TextUtils.formatDouble(User.getScreenScaling()));
	...
	public void term()
	{
		...
		double curDouble = TextUtils.atof(overallScreenScale.getText());
		if (curDouble != User.getScreenScaling())
		{
			User.setScreenScaling(curDouble);
			Job.getUserInterface().showInformationMessage("Changes to the overall screen scale take effect when Electric next starts",
				"Note");
		}
...
//			Pref.resumePrefFlushing();
    ...
    private void initComponents()
    {
        ...
        overallScreenScale = new javax.swing.JTextField();
        ...
        jLabel3.setText("Overall screen scale:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        overallScreenScale.setColumns(5);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        jPanel2.add(overallScreenScale, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        general.add(jPanel2, gridBagConstraints);
    ...
    private javax.swing.JTextField overallScreenScale;
