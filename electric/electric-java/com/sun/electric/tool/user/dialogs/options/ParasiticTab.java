...
public class ParasiticTab extends PreferencePanel {
	...
	public ParasiticTab(PreferencesFrame parent, boolean modal)
	{
	    ...
	    EDialog.makeTextFieldSelectAllOnTab(inductanceAreaFactor);
	    EDialog.makeTextFieldSelectAllOnTab(inductanceLengthFactor);
	...
	public void init()
	{
		...
		inductanceAreaFactor.getDocument().addDocumentListener(updateLayerParasitics);
		inductanceLengthFactor.getDocument().addDocumentListener(updateLayerParasitics);
	...
	public void reset()
	{
		...
		if (tech != null)
		{
			for(Iterator<Layer> it = tech.getLayers(); it.hasNext(); )
			{
	            ...
	            setDouble(layer.getInductanceAreaFactorSetting(), ((Double)layer.getInductanceAreaFactorSetting().getFactoryValue()).doubleValue());
	            setDouble(layer.getInductanceLengthFactorSetting(), ((Double)layer.getInductanceLengthFactorSetting().getFactoryValue()).doubleValue());
			}
	...
	private void layerListClick()
	{
		...
		if (layer != null)
		{
			...
			inductanceAreaFactor.setText(getFormattedDouble(layer.getInductanceAreaFactorSetting()));
			inductanceLengthFactor.setText(getFormattedDouble(layer.getInductanceLengthFactorSetting()));
		}
		changing = false;
	}
	...
	private class ParasiticLayerDocumentListener implements DocumentListener
	{
		private void change()
		{
            ...
            setDouble(layer.getInductanceAreaFactorSetting(), TextUtils.atof(inductanceAreaFactor.getText()));
            setDouble(layer.getInductanceLengthFactorSetting(), TextUtils.atof(inductanceLengthFactor.getText()));
		}
    ...
    private void initComponents()
    {
        ...
        inductanceAreaFactor = new javax.swing.JTextField();
        jLabel6 = new javax.swing.JLabel();
        inductanceLengthFactor = new javax.swing.JTextField();
        ...
        jLabel4.setText("Inductance Area Factor: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 4, 4);
        globalValues.add(jLabel4, gridBagConstraints);

        inductanceAreaFactor.setColumns(8);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 4, 4);
        globalValues.add(inductanceAreaFactor, gridBagConstraints);

        jLabel6.setText("Inductance Length Factor: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 4, 4);
        globalValues.add(jLabel6, gridBagConstraints);

        inductanceLengthFactor.setColumns(8);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 4, 4);
        globalValues.add(inductanceLengthFactor, gridBagConstraints);
    ...
    private javax.swing.JTextField inductanceAreaFactor;
    private javax.swing.JTextField inductanceLengthFactor;
